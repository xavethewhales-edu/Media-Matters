...
const scenes = {
  ...
  scene1: {
    ...
    text: `
MEDIA MATTERS — WEEK 1

AI IS CHANGING THE MEDIA BUSINESS.
WHO OWNS THE RISK?

OPENING DECISION

Your company is considering giving an AI system significantly more autonomy
over media planning, optimisation and creative workflows.
...
• better cross-channel optimisation.

But it will also interact with commercial data, external AI models
and increasingly automated decision-making.

Before discussing it, choose your INITIAL position.

There is no universally correct answer here.
Be ready to defend your choice to the group.
    `,

    choices: [
      {
        text: "Approve it, provided appropriate controls are built into the system.",
        next: "scene2_article"
      },
      {
        text: "Reject it until its legal and technical risks are substantially clearer.",
        next: "scene2_article"
      },
      {
        text: "Approve a limited pilot before making a larger commitment.",
        next: "scene2_article"
      },
      {
        text: "Approve it if the projected financial return is compelling enough.",
        next: "scene2_article"
      }
    ]
  },
...
HOW AI IS REWRITING THE PROGRAMMATIC PLAYBOOK
...
• what AI is supposedly improving;
• what is becoming more complex rather than less complex;
• where human oversight remains necessary;
• which claims sound factual and which sound predictive;
• what Legal, IT and Finance might question before accepting the argument.

Allow approximately 6–7 minutes.
...
According to the article, why is traditional identity-first thinking
no longer sufficient for modern programmatic advertising?
    `,

    choices: [
      {
        text: "Because advertisers have almost completely abandoned audience targeting.",
        next: "scene3_retry"
      },
      {
        text: "Because privacy regulation has eliminated programmatic advertising altogether.",
        next: "scene3_retry"
      },
      {
        text: "Because the combination of scale, signal loss, platform convergence and AI has made the ecosystem substantially more complex.",
        next: "scene4_article_mc"
      },
      {
        text: "Because connected television has replaced all other digital channels.",
        next: "scene3_retry"
      }
    ]
  },
  ...
  scene3_retry: {
    ...
    text: `
The article does not argue that identity has disappeared.

Its point is that identity-first thinking alone can no longer manage
the scale and complexity of the current programmatic environment.
...
Which principle does the article describe as non-negotiable
as agentic systems become more capable?
    `,

    choices: [
      {
        text: "Human judgment and accountability must remain embedded in the workflow.",
        next: "scene5_article_mc"
      },
      {
        text: "Every media decision should eventually become fully autonomous.",
        next: "scene4_retry"
      },
      {
        text: "AI systems should operate independently from existing technology stacks.",
        next: "scene4_retry"
      },
      {
        text: "Efficiency should take priority whenever human oversight slows execution.",
        next: "scene4_retry"
      }
    ]
  },
  ...
  scene4_retry: {
    ...
    text: `
The article is optimistic about automation,
but it explicitly preserves a role for human oversight,
...
What position does the article take on generative AI
and creative teams?
    `,

    choices: [
      {
        text: "Generative AI should eventually make most creative approval processes unnecessary.",
        next: "scene5_retry"
      },
      {
        text: "Creative teams will remain relevant mainly because clients resist technological change.",
        next: "scene5_retry"
      },
      {
        text: "AI should be restricted to media buying and excluded from creative work.",
        next: "scene5_retry"
      },
      {
        text: "AI can augment creative teams, while guardrails and human judgment remain necessary.",
        next: "scene6_hangman"
      }
    ]
  },
  ...
  scene5_retry: {
    ...
    text: `
The article presents AI as an augmentation tool rather than
a straightforward replacement for creative professionals.

Brand safety, integrity and judgment still require human involvement.
...
Try again.
  ...
  scene6_hangman: {
    ...
    hint: "The continuing involvement of people in monitoring, reviewing and taking responsibility for automated decisions. Two words!",
...
The article repeatedly argues that autonomous systems
still require people to monitor decisions and remain accountable.

Think:

HUMAN + supervision / control / review
...
The objective is NOT to sound uncertain.

The objective is to make claims that are precise,
defensible and appropriately qualified.
    `,
    ...
    sentence: [
      ...
      "__________",
      "implementation costs remain within the current estimate; however, residual legal exposure",
      "__________",
      "at this stage."
    ],
  ...
  scene8_language: {
    ...
    text: `
LANGUAGE LAB — CLAIMS vs EVIDENCE

Discuss the difference between these statements.
...
"The platform appears to satisfy our current security requirements,
...
"On current assumptions, the investment is expected to reach
payback within the projected period."
...
"We have not identified a material legal risk at this stage."


GROUP CHALLENGE

Why is the second formulation in each pair usually stronger
...
• at this stage
  ...
  scene9_video: {
    ...
    youtube: "https://www.youtube.com/watch?v=11uvY23Qh7M",

    text: `
VIDEO

FUTURE OF ADVERTISING AT CANNES LIONS:
AI, CTV AND COOKIELESS STRATEGIES
...
• how AI affects campaign optimisation;
• workflow efficiency;
• the shift from linear television to CTV;
• preparing for a cookieless environment;
• identity resolution and contextual advertising.
...
Then answer the questions.
    ...
    questions: [
      {
        text: "Which use of AI is explicitly central to the discussion?",
        options: [
          "Replacing all advertising agencies with software",
          "Removing the need to measure campaigns",
          "Optimising campaigns and improving workflow efficiency",
          "Eliminating the use of consumer data"
        ],
        correct: 2
      },
      {
        text: "What major media-consumption shift forms another part of the discussion?",
        options: [
          "The movement from linear television towards Connected TV",
          "The disappearance of digital video advertising",
          "The return of print as the dominant advertising medium",
          "The replacement of streaming platforms by broadcast radio"
        ],
        correct: 0
      },
      {
        text: "Which challenge is discussed in relation to future-proofing advertising strategy?",
        options: [
          "The decline of outdoor advertising",
          "The disappearance of branded content",
          "The end of campaign measurement",
          "Operating in an increasingly cookieless environment"
        ],
        correct: 3
      },
      {
        text: "Which pair of approaches is particularly relevant to preparing for reduced cookie availability?",
        options: [
          "Mass-market television and print circulation",
          "Identity resolution and contextual advertising",
          "Higher frequency and longer advertisements",
          "Influencer marketing and event sponsorship"
        ],
        correct: 1
      }
    ],
...
• AI → optimisation and workflow efficiency
• linear TV → Connected TV
• declining cookie availability
• identity resolution + contextual advertising

Watch the section again and retry.
    `,
  ...
  scene10_roles: {
    ...
    text: `
THE THREE-SEAT CHALLENGE

Your Madrid operation is considering an AI-assisted
content and media optimisation platform.
...
Expected reduction in content-production turnaround:
35%

The platform:

• requires campaign data and selected client datasets;
• uses third-party AI models;
• can automate certain optimisation decisions;
• produces some decisions that cannot yet be fully reconstructed;
• may require additional infrastructure during its useful life.


ROLE 1 — LEGAL

Identify THREE conditions you would want satisfied before approval.
...
Identify THREE technical questions that must be answered.
...
ROLE 3 — FINANCE / FIXED ASSETS

Challenge the investment assumptions.
...
• whether €650,000 represents genuine recurring savings.


Then negotiate ONE joint recommendation.
...
REJECT
    ...
    choices: [
      {
        text: "We have reached a joint position",
        next: "scene11_scramble"
      }
    ]
  },
...
Build ONE complete professional recommendation.
    `,
...
Complete the internal recommendation.
    `,

    sentence: [
      "On the basis of the information currently available, the platform",
      "__________",
      "generate measurable efficiencies. Nevertheless, approval should be",
      "__________",
      "completion of the security review, and the projected savings should not be treated",
      "__________",
      "guaranteed."
    ],
...
The platform costs €1.8m.

Claimed annual savings = €650,000.

Simple arithmetic suggests the original investment could be recovered
in under three years.

But discuss why that calculation may be misleading.
...
• technological obsolescence;
• compliance costs;
• savings that depend on headcount reductions;
• benefits that are difficult to quantify.


C1/C2 CHALLENGE

Each person must make ONE statement using:

"On the assumption that..."

and ONE counterargument using:
...
"That would only hold true if..."
    ...
    choices: [
      {
        text: "Continue to Grammar Run",
        next: "scene14_grammar_run"
      }
    ]
  },
  ...
  scene14_grammar_run: {
    ...
    endings: {
      high: "scene15_final_decision",
      medium: "scene15_final_decision",
      low: "scene14_retry"
    },

    questions: [
      {
        prompt: "The platform ___ deliver substantial savings, but the assumptions still require validation.",
        answers: ["may"],
        hint: "(must / may / will)"
      },
      {
        prompt: "The residual risk cannot be completely ___ out.",
        answers: ["ruled"],
        hint: "(ruled / taken / put)"
      },
      {
        prompt: "Approval should remain subject ___ completion of the security review.",
        answers: ["to"],
        hint: "(for / with / to)"
      },
      {
        prompt: "We have not identified a material legal obstacle ___ this stage.",
        answers: ["at"],
        hint: "(at / in / on)"
      },
      {
        prompt: "The projected savings depend ___ successful integration.",
        answers: ["on"],
        hint: "(of / on / from)"
      },
      {
        prompt: "The platform appears ___ satisfy the current technical requirements.",
        answers: ["to"],
        hint: "(to / for / at)"
      },
      {
        prompt: "The proposal is attractive, ___ that implementation costs remain controlled.",
        answers: ["provided"],
        hint: "(provided / despite / whereas)"
      },
      {
        prompt: "___ current assumptions, payback could be achieved within approximately three years.",
        answers: ["On"],
        hint: "(At / On / By)"
      }
    ]
...
The objective is precise, controlled professional language.
...
• the investment case is potentially attractive;
• the technology could create meaningful efficiencies;
• the security review is not yet complete;
• some AI decisions remain difficult to reconstruct;
• third-party models will process selected company/client data;
• the four-year useful-life assumption has not yet been stress-tested.

Which recommendation is the MOST professionally defensible?
    `,

    choices: [
      {
        text: "Reject the proposal permanently because any unresolved risk makes investment unjustifiable.",
        next: "scene15_retry"
      },
      {
        text: "Approve a controlled implementation subject to legal, technical and financial validation of the outstanding assumptions.",
        next: "scene16_email"
      },
      {
        text: "Approve immediately because the projected savings outweigh non-financial concerns.",
        next: "scene15_retry"
      },
      {
        text: "Delay all analysis until AI regulation and technology stop changing.",
        next: "scene15_retry"
      }
    ]
  },
  ...
  scene15_retry: {
    ...
    text: `
A strong executive recommendation does not need to be
unconditionally positive or negative.

The evidence suggests potential value,
but several material assumptions remain unresolved.

Look for the answer that preserves the opportunity
while attaching explicit conditions to approval.
...
You are part of the internal team reviewing the proposed
AI-assisted media platform.

Write a concise recommendation to senior management.

Include:

• your overall recommendation;
• one potential operational or financial benefit;
• one material risk or unresolved assumption;
• one condition that should be satisfied before full approval.

Use at least THREE examples of today's target language naturally.
...
Do NOT simply list the expressions.
Use them as part of a credible professional recommendation.
    `,

    teacherEmail: "xavier.benitz@gmail.com",
    emailSubject: "Media Matters — AI Investment Recommendation",
    emailBody: "",

    next: "scene16_email_sent"
  },
...
Before finishing, compare your recommendation with the position
you chose at the beginning of the lesson.

Did your position change after considering:
...
Strong professional English is not about sounding certain.

It is about being precise about
what you know,
what you assume,
and what still needs to be established.
    `,
